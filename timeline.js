...
(function () {
    ...
    var margin = {top: 40, right: 20, bottom: 40, left: 0},
        ...
        items = [
            ...
            {group: "DUT FA", content: 'Alternance', start: new Date(2014, 9, 1), end: fin, classe: "DUT"},
            ...
            {group: "LP 2", content: 'Santé', start: new Date(2006, 9, 1), end: new Date(2016, 8, 31), classe: "LP"},
            {group: "LP 2", content: 'Alternance', start: new Date(2016, 9, 1), end: fin, classe: "LP"},

            {group: "DU 1", content: "Big data", start: new Date(2015, 1, 1), end: fin, classe: "DU"},
            {group: "DU 2", content: "Dataviz", start: new Date(2016, 1, 1), end: fin, classe: "DU"},
    ...
    function separation(fois) {
        return (fois + y.paddingOuter() - 0.05) * y.step();
    }
